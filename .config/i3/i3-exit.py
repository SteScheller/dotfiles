...
class i3_exit:
    ...
    def lock_action(self,btn):
        self.disable_buttons()
        self.status.set_label("Locking i3, please standby...")
...
#                org.freedesktop.ConsoleKit.Manager.Stop")
    ...
    def invoke_i3lock(self):
        # get current background
#        cfg = ConfigParser.RawConfigParser()
#        cfg.read("/home/stefan/.config/nitrogen/bg-saved.cfg")
#        bg = cfg.get("xin_0", "file")
#        os.system("i3lock -e -f -i " + bg + " -t")
        os.system("i3lock -e -f --color=000000")
    ...
    def create_window(self):
        ...
        self.window.set_size_request(700, 70)
        ...
        #Lock button
        self.lock = gtk.Button("Loc_k screen")
